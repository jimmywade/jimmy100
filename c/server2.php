...
$idCertificacion=$_POST['IDLABORAL'];
...
if($file && move_uploaded_file($_FILES["file"]["tmp_name"], "certificacionesLaborales/".$nombre_actual))
{
	...
	if ($conn->query("UPDATE laborales SET recomendacionLaboral='$nombre_actual' WHERE idLaboral='$idCertificacion' ") === TRUE){
