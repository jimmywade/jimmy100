...
<head>
    ...
    <title> Talent | get a better job now</title>
    ...
    <script type="text/javascript" src="../c/controlador444.js"></script>
    <script>
...
<section id="milagro2" ng-controller="myController445" style="display:block; background: -webkit-linear-gradient(#E0EDFA, #0283F8);  background: -moz-linear-gradient(#E0EDFA, #0283F8);   background: -o-linear-gradient(#E0EDFA, #0283F8);">
...
<div class="container" style="background-color:#585858; color:#d5d5d5;" >
    <div class="col-xs-12 col-sm-12 col-md-12 col-sm-offset-0 col-md-offset-0">
        <hr>
        <h1 style="text-align:center; font-family:myriad pro;">CONSIGUE UN MEJOR EMPLEO AHORA MISMO</h1>
        <hr>
    </div>
</div> <!-- div container -->
<hr>
...
<div class="container" style="margin-bottom:50px; padding:0;">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-sm-offset-0 col-md-offset-0">
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner" role="listbox">
                        <div class="item active">
                          <img src="../img/d1.png" alt="I´m talent for Employers">
                          <div class="carousel-caption" style="background-color: rgba(0, 0, 0, 0.3); color:#FFF;">
                            <h3>I´m Talent</h3>
                            <p>Accede ya a ofertas laborales de las mejores empresas nacionales e internacionales.</p>
                          </div>
                        </div>

                        <div class="item">
                          <img src="../img/d2.png" alt="I´m talent for Employers">
                          <div class="carousel-caption" style="background-color: rgba(0, 0, 0, 0.3); color:#FFF;">
                            <h3>I´m Talent</h3>
                            <p>La forma mas rapida y sencilla de encontrar empleo.</p>
                          </div>
                        </div>

                        <div class="item">
                          <img src="../img/d3.png" alt="I´m talent for Employers">
                          <div class="carousel-caption" style="background-color: rgba(0, 0, 0, 0.3); color:#FFF;">
                            <h3>I´m Talent</h3>
                            <p>Acceda a miles de vacantes de las mejores empresas sin membresia y sin cargos mensuales.</p>
                          </div>
                        </div>

                        <div class="item">
                          <img src="../img/d4.png" alt="I´m talent for Employers">
                          <div class="carousel-caption" style="background-color: rgba(0, 0, 0, 0.3); color:#FFF;">
                            <h3>I´m Talent</h3>
                            <p>Conseguir un mejor empleo esta a solo un click.</p>
                          </div>
                        </div>
                      </div>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4 col-sm-offset-2 col-md-offset-2">
                    ...
                    <form class="form-horizontal" role="form" id="registroPersonas">
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-12 col-md-12 izquierdo" for="ncomer">Nombre y apellidos:</label>
                        ...
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-12 col-md-12 izquierdo" for="naci">Fecha de nacimiento:</label>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <input ng-model="nacimiento" type="date" class="form-control" id="naci" style="border:solid 1px #E0EDFA;" placeholder="Ejemplo: 1986-12-30" required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-xs-12 col-sm-12 col-md-12 izquierdo" for="ese">Seleccionar sexo:</label>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <select ng-model="sexoPersona" class="form-control" id="ese" required>
                        ...
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-12 col-md-12 izquierdo" for="ec">Estado Civil:</label>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div id="desactivado" class="col-xs-12 col-sm-12 col-md-12 col-sm-offset-0 col-md-offset-0" style="display:none;">
                                <section class="container-fluid fondo-gris2" style="padding:0; border-radius:8px; border:solid 2px #E0EDFA;" id="payciu">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-sm-offset-0 col-md-offset-0" style="padding:0; overflow:scroll; height:250px; clear:both; border:solid 1px #C9DAFB;" >
                                        <table class="table">
                                            <tr ng-repeat="post444 in posts444 | filter: searchKeyword ">
                                                <td>{{post444.nombrePais}}</td>
                                                <td>-</td>
                                                <td>{{post444.nombreCiudad}}</td>
                                                <td><input id="{{post444.idCiudad}}" type="radio" ng-click="sete445(post444.nombrePais,post444.nombreCiudad,post444.idPais,post444.idCiudad)" ></td>
                                            </tr>
                                        </table>
                                    </div>
                                </section>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <input ng-model="direccion" type="text" class="form-control" id="dir" maxlength="39" style="border:solid 1px #E0EDFA;" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-12 col-md-12 izquierdo" for="tel">Tel&eacute;fono:</label>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <table width=100%>
                            <tr>
                                <td width=49%><label class="col-xs-12 col-sm-12 col-md-12 izquierdo" style="padding:0;" for="pwd">Contrase&ntilde;a:</label></td>
                                <td width=2%>&nbsp;&nbsp;&nbsp;</td>
                                <td width=49%><label class="col-xs-12 col-sm-12 col-md-12 izquierdo" style="padding:0;" for="pwd2">Repetir contrase&ntilde;a:</label></td>
                            </tr>
                            <tr>
                                <td width=49%><input ng-model="password" type="password" class="form-control" id="pwd" maxlength="29" style="border:solid 1px #E0EDFA;" required></td>
                                <td width=2%>&nbsp;&nbsp;&nbsp;</td>
                                <td width=49%><input ng-model="password2" type="password" class="form-control" id="pwd2" maxlength="29" style="border:solid 1px #E0EDFA;" required></td>
                            </tr>
                        </table>



                        <div id="somethingS" class="form-group" style="display:none;">
                            <br>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-xs-offset-0 col-sm-offset-0 col-md-offset-0" style="background-color: rgba(0, 0, 0, 0.6);">
                                <h5 style="color:red;"><i>Parece que este correo electrónico ya tiene una cuenta en I´M TALENT<br>Por favor ingresa un email diferente ó <a href="../v/login.html">pulsa aqui para iniciar sesión</a></i></h5>
                            </div>
                        </div>
                        ...
                        <div class="form-group">        
                            <div class="col-xs-12 col-sm-12 col-md-12 col-xs-offset-0 col-sm-offset-0 col-md-offset-0">
                                <br><br>
                                <button ng-click="reg445()" class="btn btn-default"><b>&nbsp;&nbsp;&nbsp;Registrarse&nbsp;&nbsp;&nbsp;</b></button>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-xs-offset-0 col-sm-offset-0 col-md-offset-0" style="font-size:11px; text-align:right; color:#D5D5D5;">
                            <span>Al hacer clic en Registrarse, aceptas los <a style="color:#BEBEBE;" href="../v/terminosycondiciones.php">Terminos y Condiciones</a> de uso del servicio.</span>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-4 col-xs-offset-0 col-sm-offset-0 col-md-offset-0">
                        <a href="../v/login.html"><button class="btn btn-default">Iniciar sesi&oacute;n</button></a>
                    </div>
...
<div id="elena2" style="display:none; padding:0; height:100%;">
    <div class="container-fluid" style="margin-top:5%; margin-bottom:5%; padding:0;">
        <div class="col-xs-12 col-sm-12 col-md-8  col-sm-offset-0 col-md-offset-4" style="color:#585858; padding:0;">
            ...
            <br><br><br><br>
            <a href="../v/login.html" class="btn btn-primary" role="button">Iniciar sesion</a>  
