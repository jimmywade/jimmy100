...
class Persona{
    ...
    public function personaCreate($codigoPersona,$codigoInstitucion,$nombrePersona,$emailPersona,$passwordPersona,$imagenPersona){
    	$sql = "
        INSERT INTO Personas (codigoPersona,codigoInstitucion,nombrePersona,emailPersona,passwordPersona,imagenPersona)
